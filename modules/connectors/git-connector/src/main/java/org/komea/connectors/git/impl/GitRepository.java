...
import org.komea.connectors.git.utils.GitRepositoryReaderUtils;
...
public class GitRepository implements IGitRepository
{
    ...
    public Set<String> getAllTagsFromABranch(final String _branchName) {
        ...
        GitRepositoryReaderUtils.switchBranch(this.getGit(), _branchName);
    ...
    public List<Ref> getBranches() {
        ...
        final List<Ref> branches = GitRepositoryReaderUtils.listRemoteBranches(this.getGit());
        return branches;
    }
