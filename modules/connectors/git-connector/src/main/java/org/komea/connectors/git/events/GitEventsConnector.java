...
public class GitEventsConnector
{
    ...
    public void launch(final GitConnectorConfiguration options) {
        ...
        try {
            ...
            IGitCommitProcessor processor = buildCommitsProcessor(options,gitRepository.getGit());
    ...
    private IGitCommitProcessor buildCommitsProcessor(final GitConnectorConfiguration options,final Git git) {
        ...
        TimedCompositeCommitProcessor processor = new TimedCompositeCommitProcessor(options.getSince(), options.getUntil());
        ...
        processor.addCommitProcessor(new FileModificationEventProducer(this.storage,git));
        return processor;
    }
