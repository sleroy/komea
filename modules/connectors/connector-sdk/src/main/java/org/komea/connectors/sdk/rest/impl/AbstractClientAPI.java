...
public abstract class AbstractClientAPI implements IRestClientAPI {
	...
	public AbstractClientAPI() {
		super();
		this.client = new ResteasyClientBuilder().disableTrustManager().build();
	...
	public Builder createRequest(final String... _params) {

		WebTarget path = this.prefixPath(this.getTarget());
	...
	public Builder createRequestWithBaseURL(final String _url,
	 ...
	 * @see
	 * org.komea.connectors.sdk.rest.product.rest.client.api.IRestClientAPI#get(java.lang.String,
	 * java.lang.Class)
	 */
	@Override
	public void delete(final String _url, final String... params)
		...
		final Response response = this.createRequestWithBaseURL(_url, params)
				.delete();
	 ...
	 */
	@Override
	public void deleteURL(final String... params) throws ConnectException,
	ServerException {

		final Response response = this.createRequest(params).delete();
		this.validateResponse(response);
	...
	public <R> R get(final Class<R> _returnType, final String... _params)
		...
		final Response response = this.createRequest(_params).get();
		this.validateResponse(response);
	...
	public <R> R get(final String _url, final GenericType<R> _returnType,
		...
		final Response response = this.createRequestWithBaseURL(_url, _params)
				.get();
		this.validateResponse(response);
		final R value = response.readEntity(_returnType);
	 ...
	 * @throws ServerException
	 * @see
	 * org.komea.connectors.sdk.rest.product.rest.client.api.IRestClientAPI#post(java.lang.String,
	 * java.lang.Object)
	 */
	@Override
	public <T> void post(final String _url, final T _objectToSend)
		...
		final Response response = this.createRequest(_url).post(
	...
	public <T, R> R post(final String url, final T _objectToSend,
		...
		final Response response = this.createRequest(url).post(
		                                                       Entity.json(_objectToSend));
		this.validateResponse(response);
		final R value = response.readEntity(_returnType);
		response.close(); // close connection
	...
	@Override
	public <T, R> R post(final T _objectToSend, final Class<R> _returnType,
			final String... params) throws ServerException,
			ConnectException {

		final Response response = this.createRequest(params).post(
		                                                          Entity.json(_objectToSend));
		this.validateResponse(response);
		final R value = response.readEntity(_returnType);
		response.close(); // close connection
	 ...
	 */
	@Override
	public <T> void postURL(final T _objectToSend, final String... params)
			throws ConnectException, ServerException {
	...
	protected void validateResponse(final Response response)
			throws ServerException {
