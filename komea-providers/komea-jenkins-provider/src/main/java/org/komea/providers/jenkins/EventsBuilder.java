...
public abstract class EventsBuilder {
    ...
    public static EventSimpleDto createStartedByUser(final long start, final int buildNumber,
            final String jenkinsProjectName, final String providerUrl, final String user,
            final String projectKey,
            final String branch) {
    ...
    public static EventSimpleDto createBuildBroken(final long start, final int buildNumber,
            final String jenkinsProjectName, final String providerUrl, final String user,
            final String projectKey,
            final String branch) {
        final String message = "User " + user + " may have broken the build for job " + jenkinsProjectName;
        final Map<String, String> properties = new HashMap<String, String>(0);
        properties.put("date", String.valueOf(start));
        properties.put("project", projectKey);
        properties.put("jenkinsProject", jenkinsProjectName);
    ...
    public static EventSimpleDto createBuildFixed(final long start, final int buildNumber,
            final String jenkinsProjectName, final String providerUrl, final String user,
            final String projectKey,
            final String branch) {
        final String message = "User " + user + " may have fixed the build for job " + jenkinsProjectName;
        final Map<String, String> properties = new HashMap<String, String>(0);
        properties.put("date", String.valueOf(start));
        properties.put("project", projectKey);
        properties.put("jenkinsProject", jenkinsProjectName);
    ...
    public static EventSimpleDto createJobConfigurationChanged(
            final String jenkinsProjectName, final String providerUrl, final String user,
            final String projectKey, final String branch) {
        final String message = "User " + user + " changed configuration of job " + jenkinsProjectName;
        final Map<String, String> properties = new HashMap<String, String>(0);
        properties.put("project", projectKey);
        properties.put("jenkinsProject", jenkinsProjectName);
        properties.put("branch", branch);
    ...
    public static EventSimpleDto createCodeChangedEvent(final long start, final int buildNumber,
            final String jenkinsProjectName, final String providerUrl,
            final int nbCommits, final String commiter,
            final String projectKey,
            final String branch) {
        final String message = "User " + commiter + " did " + nbCommits
                + " comit(s) since last build of job " + jenkinsProjectName;
        final Map<String, String> properties = new HashMap<String, String>(0);
        properties.put("date", String.valueOf(start));
        properties.put("project", projectKey);
        properties.put("jenkinsProject", jenkinsProjectName);
    ...
    public static EventSimpleDto createIndustrializationEvent(
        ...
        final String message = "Jenkins build industrialization for job " + jenkinsProjectName
