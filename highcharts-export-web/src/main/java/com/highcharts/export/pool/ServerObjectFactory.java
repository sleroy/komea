...
import com.highcharts.export.server.PhantomJsLocator;
...
public class ServerObjectFactory implements ObjectFactory<Server> {
    ...
    public String getExecLocation() {
        final PhantomJsLocator phantomJsLocator = new PhantomJsLocator();
        final String location = phantomJsLocator.getLocation();
        return location;
    }
