...
public class WicketApplication extends AuthenticatedWebApplication {
	...
	public void init() {
		...
		if (!isDebugMode()) {
			...
			getComponentInstantiationListeners().add(new SpringComponentInjector(this, contextMock));
		}
		...
		LOGGER.debug("#############################################################");
		final Set<Entry<String, Class<? extends WebPage>>> entrySet = getPluginAdminPage().getRegisteredPages()
		        .entrySet();
