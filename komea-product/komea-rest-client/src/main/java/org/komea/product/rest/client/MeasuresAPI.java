...
public class MeasuresAPI extends AbstractRestCientAPI implements IMeasuresAPI
{
     ...
     * (non-Javadoc)
     * 
     * @see org.komea.product.rest.client.api.IMeasuresAPI#lastMeasuresForEntity(org.komea.product.service.dto.KpiKey)
     */
    @Override
    public double lastMeasuresForEntity(final KpiKey _kpiKey) throws InternalServerException, ConnectException {
