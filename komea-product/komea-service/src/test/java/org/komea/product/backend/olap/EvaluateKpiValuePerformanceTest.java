...
public class EvaluateKpiValuePerformanceTest extends AbstractPerformanceTest {
    ...
    public void groupElementsPerDay() {
        ...
        basicMicroBenchmark.run(new Runnable() {
            ...
            public void run() {
                ...
                statisticsAPI.evaluateKpiValue(timeSerieOptions, EntityKey.of(EntityType.PROJECT, 1));
