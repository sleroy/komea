...
public class KPIServiceITest extends AbstractSpringIntegrationTestCase
{
    ...
    public void testBug2() {
        ...
        final Measure measure = kpiValueService.getRealTimeMeasure(KpiKey.ofKpi(kpi));
        Assert.assertNotNull("Should be filtered and work", measure);
    ...
    @Test(
        expected = KpiAlreadyExistingException.class)
    ...
    public void testBugForIndividualKPI() {
        ...
        final Measure measure2 = kpiValueService.getRealTimeMeasure(KpiKey.ofKpi(kpi));
