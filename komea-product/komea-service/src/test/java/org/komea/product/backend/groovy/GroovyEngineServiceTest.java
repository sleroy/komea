...
public class GroovyEngineServiceTest {
	...
	/**
	 * Test method for
	 * {@link org.komea.product.backend.groovy.GroovyEngineService#parseClass(java.io.File)}
	 * .
	 */
	@Test
	public final void testParseClass() throws Exception {
		...
		final Comparator<Integer> comparator = (Comparator<Integer>) ClassUtils.instantiate(groovyEngineService
		        .parseClass(scriptExample));
		assertEquals("Test functionality ", comparator.compare(1, 2), Integer.valueOf(1).compareTo(2));

	}

	@Test
	public void testParseScript() {
		final Script parseGroovyScript = groovyEngineService
		        .parseScript("new org.komea.eventory.query.CEPQuery(new org.komea.eventory.query.predefined.EmptyQueryDefinition())");
