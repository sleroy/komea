...
/**
 * This class defines the administration actions offered through the Admin GUI. An action of administration offers basically a command to be
...
public class AdminActionServices implements IAdminActionServices
{
    ...
    private static class StringProgressListener implements ProgressListener
    {
        ...
        /*
         * (non-Javadoc)
         * @see org.komea.product.backend.service.ProgressListener#progressFinish(org.komea.product.backend.service.ProgressEvent)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.komea.product.backend.service.ProgressListener#progressStart(org.komea.product.backend.service.ProgressEvent)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.komea.product.backend.service.ProgressListener#progressUpdate(org.komea.product.backend.service.ProgressEvent)
         */
        @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.IAdminActionServices#executeAction(org.komea.product.backend.api.IAdminAction)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.IAdminActionServices#registerAdminAction(org.komea.product.backend.api.IAdminAction)
     */
    @Override
