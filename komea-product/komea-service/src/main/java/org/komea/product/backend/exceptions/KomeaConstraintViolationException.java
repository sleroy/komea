...
public class KomeaConstraintViolationException extends ValidationException
{
     ...
     */
    public KomeaConstraintViolationException(final Set<ConstraintViolation<?>> constraintViolations) {
    ...
    public String toString() {
        ...
        return "ConstraintViolationException [constraintViolations=" + constraintViolations + "]";
    }
