...
public class KpiAPIService implements IKpiAPI
{
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#computeAverageFromMeasures(java.util.List)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#computeSumFromMeasures(java.util.List)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getAllKpisOfEntityType(org.komea.product.database.enums.EntityType)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getBaseKpisOfGroupKpiKeys(java.util.List)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getKpiAsMeasures(java.lang.String,
     * org.komea.product.database.dto.KpiMeasureFilter)
     */
    @Override
    public Collection<? extends MeasureDto> getKpiAsMeasures(
            final String _kpi,
            final KpiMeasureFilter _kpiMeasureFilter) {
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getKpisForGroups(java.util.List)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getKpisOfGroupKpiKeys(java.util.List, java.util.List)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getKpiValues(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getKpiValuesAverageOnPeriod(java.lang.String, org.joda.time.DateTime)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getLastStoredValueInHistory(org.komea.product.database.model.Kpi,
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getMeasures(java.util.List, java.util.List,
     * org.komea.product.database.dto.SearchMeasuresDto)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getRealTimeMeasuresFromEntities(java.util.List, java.util.List)
     */
    @Override
    public List<MeasureDto> getRealTimeMeasuresFromEntities(
            final List<Kpi> _baseKpis,
            final List<BaseEntityDto> _subEntitiesDto) {
    
    
        return kpiValueService.getRealTimeMeasuresFromEntities(_baseKpis, _subEntitiesDto);
    }
    
    
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#getSelectionOfKpis(org.komea.product.database.enums.EntityType, java.util.List)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.kpi.IKpiAPI#storeValueInHistory(org.komea.product.service.dto.KpiKey, java.lang.Double)
     */
    @Override
