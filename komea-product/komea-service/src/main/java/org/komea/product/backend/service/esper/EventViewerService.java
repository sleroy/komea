...
public class EventViewerService implements IEventViewerService, PostSettingRegistration {
     ...
     * @return List<IEvent>
     * @see
     * org.komea.product.backend.service.esper.IEventViewerService#getInstantView(String)
     */
    @Override
     ...
     *
     * @param _retentionEventBlocker the setting key
     * @return the retention period.
     */
     ...
     *
     * @param _esperService IEventEngineService
     */
