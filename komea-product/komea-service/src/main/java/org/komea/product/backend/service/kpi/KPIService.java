        ...
        IKPIService
{
     ...
     */
    @Override
    public int deleteByCriteria(final KpiCriteria example) {
    ...
    public void deleteKpi(final Kpi kpi) {
        ...
        for (final Kpi kpiByEntityType : allKpisOfEntityType) {
            if (kpiByEntityType.getId() != idKpi
                    && kpiFormula.equals(kpiByEntityType.getEsperRequest())) {
    ...
    @Override
    public boolean isKpiFormulaShared(final Kpi _kpi) {
        ...
        for (final Kpi kpi : kpis) {
            if (formula.equals(_kpi.getEsperRequest()) && _kpi.getId() != kpi.getId()) {
                return true;
            }
        }
        return false;
    ...
    @Override
    public List<Kpi> selectByCriteriaWithBLOBs(final KpiCriteria _criteria) {
