...
public final class EntityService implements IEntityService {
     ...
     *
     * @see
     * org.komea.product.backend.service.entities.IEntityService#findEntityAssociatedToKpi(org.komea.product.service.dto.KpiKey)
     */
    @Override
    ...
    @Override
    public List<? extends IEntity> getSubEntities(final Integer _entityId,
