...
public class MeasureService implements IMeasureService {
    ...
    public List<TimeSerieDTO> findMultipleHistoricalMeasure(
        ...
        final Collection<Kpi> kpis = kpiService.selectByKeys(kpiKeys);
        LOGGER.trace("Kpis {}", kpis);
        final Collection<IEntity> entities = entityService.getEntitiesByKey(entityType, entityKeys);
     ...
     *
     * @param _coordinates the coordinates.
     * @return
     */
