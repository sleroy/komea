...
public class EventStatisticsService implements IEventStatisticsService {
     ...
     *
     * @param _criticity test the severity
     * @return
     */
     ...
     * @return List<Measure>
     * @see
     * org.komea.product.backend.service.esper.IEventStatisticsService#getAllMeasures()
     */
    @Override
     ...
     * @return long
     * @see
     * org.komea.product.backend.service.esper.IEventStatisticsService#getNumberOfAlerts(Severity)
     */
    @Override
     ...
     * @return long
     * @see
     * org.komea.product.backend.service.esper.IEventStatisticsService#getReceivedAlertsIn24LastHours()
     */
    @Override
     ...
     * @see
     * org.komea.product.backend.service.esper.IEventStatisticsService#getReceivedAlertTypesIn24LastHours()
     */
    @Override
    ...
    /**
     * @param _eventPushService the eventPushService to set
     */
    ...
    /**
     * @param _esperEngine the cepEngine to set
     */
    ...
    /**
     * @param _systemProject the systemProject to set
     */
