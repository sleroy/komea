...
public class ProviderFormula implements ICEPFormula<IEvent, EventTypeStatistics> {
	...
	public static class ProviderEventTypeTuple {
		...
		public boolean equals(final Object obj) {
			...
			if (providerName == null) {
				if (other.providerName != null) { return false; }
			} else if (!providerName.equals(other.providerName)) { return false; }
			return true;
		}
		...
		public String toString() {
			...
			return "ProviderEventTypeTuple [eventType=" + eventType + ", providerName=" + providerName + "]";
		}
	}

	public static class ProviderEventTypeTupleCreator implements ITupleCreator<IEvent, ProviderEventTypeTuple> {
		...
		public ProviderEventTypeTuple create(final IEvent _event) {
			...
			return new ProviderEventTypeTuple(_event.getProvider().getKey(), _event.getEventType().getKey());
	...
	public EventTypeStatistics compute(final ICEPStatement<IEvent> _arg0) {
		...
		final EventTable<ProviderEventTypeTuple, IEvent> eventTable = new EventTable<ProviderEventTypeTuple, IEvent>(
		        new ProviderEventTypeTupleCreator());
		eventTable.fill(_arg0.getAggregateView());

		final EventTypeStatistics eventTypeStatistics = new EventTypeStatistics();
		for (final Entry<ProviderEventTypeTuple, IEventGroup<IEvent>> eventGroupEntry : eventTable.iterator()) {
			...
			eventTypeStatistic.setValue(eventValueFormula.evaluate(eventGroupEntry.getValue()).intValue());
