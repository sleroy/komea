        ...
        implements IProjectService
{
    ...
    public List<ProjectDto> getAllProjectsAsDtos() {
        ...
        final List<Project> allProjectsEntities = getAllProjectsEntities();
    ...
    public List<Project> getProjectsOfPersonGroupRecursively(final Integer _personGroupId) {
        ...
        if (personGroup == null) { throw new IllegalArgumentException(
    ...
    /**
     * Initializes a new empty project from the key. It provides a default description and name.
     * 
     * @param _projectKey
     *            the project key
