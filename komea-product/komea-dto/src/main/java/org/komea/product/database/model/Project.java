...
public class Project implements IEntity {
    ...
    private static final Joiner ALIASES_JOINER = Joiner.on(ALIASES_SEPARATOR).skipNulls();
    private static final Splitter ALIASES_SPLITTER = Splitter.on(ALIASES_SEPARATOR).omitEmptyStrings().trimResults();
    ...
    public void setAliasesList(final List<String> aliasesList) {
        this.alias = ALIASES_JOINER.join(aliasesList);
    }
