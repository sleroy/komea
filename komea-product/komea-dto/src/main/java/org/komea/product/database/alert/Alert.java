...
public class Alert implements IAlert
{
    ...
    public boolean equals(final Object obj) {
        ...
        if (criticity != other.criticity) { return false; }
        if (date == null) {
            if (other.date != null) { return false; }
        } else if (!date.equals(other.date)) { return false; }
        if (fullMessage == null) {
            if (other.fullMessage != null) { return false; }
        } else if (!fullMessage.equals(other.fullMessage)) { return false; }
        if (icon == null) {
    ...
    public int hashCode() {
        ...
        result = prime * result + (fullMessage == null ? 0 : fullMessage.hashCode());
    ...
    public String toString() {
        ...
        return "Alert [date="
                + date + ", provider=" + provider + ", category=" + category + ", type=" + type
                + ", project=" + project + ", users=" + users + ", team=" + team + ", criticity="
                + criticity + ", message=" + message + ", fullMessage=" + fullMessage + ", params="
                + params + ", value=" + value + ", URL=" + URL + ", icon=" + icon + "]";
    }
}
