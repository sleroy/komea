...
public class BaseEntityDto implements IEntity, Comparable<BaseEntityDto> {
    ...
    public static BaseEntityDto newFromMember(final Person _person) {
        ...
        return new BaseEntityDto(EntityType.PERSON, _person.getId(), _person.getLogin(), _person.getFullName(), _person.getEmail());
    }
    ...
    public static BaseEntityDto newFromPersonGroup(final PersonGroup _personGroup) {
        ...
        return new BaseEntityDto(_personGroup.getEntityKey().getEntityType(), _personGroup.getId(), _personGroup.getPersonGroupKey(),
                _personGroup.getName(), _personGroup.getDescription());
    ...
    public static BaseEntityDto newFromProject(final Project _project) {
        ...
        return new BaseEntityDto(_project.getEntityKey().getEntityType(), _project.getId(), _project.getProjectKey(), _project.getName(),
     ...
     */
    public static BaseEntityDto newFromEntity(final IEntity _entity) {
    ...
    public BaseEntityDto(final EntityType entityType, final Integer id, final String key, final String name, final String description) {
    ...
    public String toString() {
        ...
        return "BaseEntityDto{" + "entityType=" + entityType + ", id=" + id + ", key=" + key + ", name=" + name + ", description="
                + description + '}';
    }
}
