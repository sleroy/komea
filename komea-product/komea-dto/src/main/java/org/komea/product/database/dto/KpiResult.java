...
public class KpiResult {
	 ...
	 */
	public KpiResult inferResults(List<IEntity> entitiesByEntityType,
			Double _minValue) {
		KpiResult kpiResult = new KpiResult(new HashMap<EntityKey, Number>(map));
		for (IEntity entity : entitiesByEntityType) {
			EntityKey entityKey = entity.getEntityKey();
