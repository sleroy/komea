...
public class PersonGroup implements Serializable, IEntity
{
     ...
     * @mbggenerated Wed Feb 05 15:26:17 CET 2014
     */
    public PersonGroup(final Integer id, final String name, final String personGroupKey, final String description,
            final Integer idPersonGroupParent, final Integer idGroupKind) {
