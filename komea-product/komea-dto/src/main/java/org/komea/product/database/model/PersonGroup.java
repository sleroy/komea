...
public class PersonGroup implements IEntity, Serializable {
     ...
     * @mbggenerated Fri Feb 14 12:56:55 CET 2014
     */
    public PersonGroup(Integer id, String name, String personGroupKey, String description, Integer idPersonGroupParent, PersonGroupType type) {
        this.id = id;
        this.name = name;
    ...
    public EntityType entityType() {
        return EntityType.valueOf(this.getType().name());
    }
}