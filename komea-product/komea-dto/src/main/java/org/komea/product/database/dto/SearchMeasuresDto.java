...
public class SearchMeasuresDto implements Serializable
{
     ...
     * @return
     */
    public boolean hasNoSpecificKpisRequested() {
    
    
        return kpiKeys.isEmpty();
    }
    ...
    public String toString() {
        ...
        return "SearchMeasuresDto{"
                + "extendedEntityType=" + extendedEntityType + ", kpiKeys=" + kpiKeys
                + ", entityKeys=" + entityKeys + ", nbMeasures=" + nbMeasures + ", fromDate="
