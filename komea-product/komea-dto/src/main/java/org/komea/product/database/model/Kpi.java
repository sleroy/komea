...
public class Kpi implements IHasKey
{
    ...
    public static Kpi copy(final Kpi kpi) {
        ...
        return new Kpi(kpi.getId(), kpi.getKpiKey(), kpi.getName(), kpi.getDescription(),
                kpi.getValueMin(), kpi.getValueMax(), kpi.getValueDirection(), kpi.getValueType(),
                kpi.getGroupFormula(), kpi.getEntityType(), kpi.getCronExpression(),
    ...
    public Kpi(
            ...
            final GroupFormula _groupFormula,
     ...
     * @mbggenerated Thu May 08 16:31:55 CEST 2014
     */
    public void setNameAndDescription(final String name) {
    ...
    public String toString() {
        ...
        return "Kpi [cronExpression="
                + cronExpression + ", description=" + description + ", entityType=" + entityType
                + ", esperRequest=" + esperRequest + ", id=" + id + ", kpiKey=" + kpiKey
                + ", name=" + name + ", providerType=" + providerType + ", valueDirection="
                + valueDirection + ", valueMax=" + valueMax + ", valueMin=" + valueMin
                + ", valueType=" + valueType + ", groupFormula=" + groupFormula + "]";
    }
