...
public class Kpi implements IHasKey {
    ...
    public Kpi(final Integer id, final String kpiKey, final String name, final String description, final Double valueMin,
            final Double valueMax, final ValueDirection valueDirection, final ValueType valueType, final EntityType entityType,
            final Integer entityID, final String cronExpression, final Integer evictionRate, final EvictionType evictionType,
            final Double objective, final ProviderType providerType) {
    ...
    public Kpi(final Integer id, final String kpiKey, final String name, final String description, final Double valueMin,
            final Double valueMax, final ValueDirection valueDirection, final ValueType valueType, final EntityType entityType,
            final Integer entityID, final String cronExpression, final Integer evictionRate, final EvictionType evictionType,
            final Double objective, final ProviderType providerType, final String esperRequest) {
    ...
    public String computeKPIEsperKey() {
        ...
        if (getEntityID() != null) {
            sb.append("_ENTITY_").append(getEntityID());
        }
        return sb.toString();
    }
     ...
     *
     * @param objective
     *            the value for kom_kpi.objective
     * @mbggenerated Thu Mar 06 10:32:30 CET 2014
     */
    ...
    public static List<Kpi> getKpisForGroups(final Kpi kpi) {
        ...
        if (ValueType.FLOAT.equals(kpi.getValueType()) || ValueType.INT.equals(kpi.getValueType())) {
