...
public class Kpi implements Serializable {
     ...
     * @mbggenerated Tue Feb 11 10:22:30 CET 2014
     */
    public Kpi(final Integer id, final String kpiKey, final String name, final String description, final Integer idProvider,
            final Double valueMin, final Double valueMax, final ValueDirection valueDirection, final ValueType valueType,
            final EntityType entityType, final Integer entityID, final String cronExpression, final Integer evictionRate,
            final EvictionType evictionType, final String esperRequest) {
    ...
    public Kpi(final Integer _id, final String _kpiKey, final String _name, final String _description, final Integer _idProvider,
            final Double _valueMin, final Double _valueMax, final ValueDirection _valueDirection, final ValueType _valueType,
            final EntityType _entityType, final Integer _entityID, final String _cronExpression, final Integer _evictionRate,
