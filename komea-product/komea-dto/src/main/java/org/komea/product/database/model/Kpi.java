...
public class Kpi implements IHasKey {
    ...
    public static Kpi copy(final Kpi kpi) {
        ...
        return new Kpi(kpi.getId(), kpi.getKpiKey(), kpi.getName(), kpi.getDescription(), kpi.getValueMin(), kpi.getValueMax(),
                kpi.getValueDirection(), kpi.getValueType(), kpi.getGroupFormula(), kpi.getEntityType(), kpi.getCronExpression(),
                kpi.getProviderType(), kpi.getEsperRequest());
    }
    ...
    public Kpi(final Integer _id, final String _kpiKey, final String _name, final String _description, final Double _valueMin,
            final Double _valueMax, final ValueDirection _valueDirection, final ValueType _valueType, final GroupFormula _groupFormula,
            final EntityType _entityType, final String _cronExpression, final ProviderType _providerType) {
    ...
    public Kpi(final Integer _id, final String _kpiKey, final String _name, final String _description, final Double _valueMin,
            final Double _valueMax, final ValueDirection _valueDirection, final ValueType _valueType, final GroupFormula _groupFormula,
            final EntityType _entityType, final String _cronExpression, final ProviderType _providerType, final String _esperRequest) {
    ...
    public String toString() {
        ...
        return "Kpi [cronExpression=" + cronExpression + ", description=" + description + ", entityType=" + entityType + ", esperRequest="
                + esperRequest + ", id=" + id + ", kpiKey=" + kpiKey + ", name=" + name + ", providerType=" + providerType
                + ", valueDirection=" + valueDirection + ", valueMax=" + valueMax + ", valueMin=" + valueMin + ", valueType=" + valueType
