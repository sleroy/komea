...
public class Kpi implements Serializable {
    ...
    public void Kpi(Integer _id, String _kpiKey, String _name, String _description, Integer _idProvider, Double _valueMin, Double _valueMax, ValueDirection _valueDirection, ValueType _valueType, EntityType _entityType, Integer _entityID, String _cronExpression, Integer _evictionRate, EvictionType _evictionType) {
        this.id = _id;
        this.kpiKey = _kpiKey;
        this.name = _name;
