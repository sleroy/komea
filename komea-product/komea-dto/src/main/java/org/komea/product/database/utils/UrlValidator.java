 ...
 * little resemblance to the php original.</p>
 * <pre>
 *   Example of usage:
 ...
 * </a>
 *
 * @version $Revision: 1227719 $ $Date: 2012-01-05 18:45:51 +0100 (Thu, 05 Jan
 * 2012) $
 * @since Validator 1.4
 */
public class UrlValidator implements Serializable {
    ...
    /**
     * Allow local URLs, such as http://localhost/ or http://machine/ . This
     * enables a broad-brush check, for complex local machine name validation
     * requirements you should create your validator with a
     * {@link RegexValidator} instead
    ...
    /**
     * Regular expressions used to manually validate authorities if IANA domain
     * name validation isn't desired.
     */
     ...
     *
     * @param schemes Pass in one or more url schemes to consider valid, passing
     * in a null will default to "http,https,ftp" being valid. If a non-null
     * schemes is specified then all valid schemes must be specified. Setting
     * the ALLOW_ALL_SCHEMES option will ignore the contents of schemes.
     */
     ...
     * declared in this class. To set multiple options you simply add them
     * together. For example, ALLOW_2_SLASHES + NO_FRAGMENTS enables both of
     * those options.
     */
     ...
     * <p>
     * <code>ALLOW_2_SLASHES + NO_FRAGMENTS</code></p>
