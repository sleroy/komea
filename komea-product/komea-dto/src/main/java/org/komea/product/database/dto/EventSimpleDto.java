...
public class EventSimpleDto implements Serializable {
    ...
    /**
     * This method the the message of the event
     * 
     * @param _messagePattern
     *            the message pattern with {number} template
     *            (ex my message : {0} )
     * @param arguments
     *            the message pattern arguments
     */
    public void setMessage(final String _messagePattern, final Object... arguments) {
    
        message = MessageFormat.format(_messagePattern, arguments);
