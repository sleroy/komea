...
public interface IKpiAPI {
     ...
     * @return the measures
     * @deprecated use IMeasureService.findHistoricalMeasure
     */
    @Deprecated
    MeasureResult getHistoricalMeasure(HistoryStringKey _historyKey, PeriodCriteria _limit);
     ...
     * @deprecated use IMeasureService.findMupltipleHistoricalMeasure
     */
    @Deprecated
    List<MeasureResult> getHistoricalMeasures(HistoryStringKeyList _historyKeys, PeriodCriteria _limit);
    /**
