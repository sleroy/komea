...
public interface IStatisticsAPI {
     ...
     *
     * @param _kpiMeasures the kpi measures
     ...
     * @param _kpiKeys the kpi and entity
     ...
     *
     * @param _kpiID the kpi name
     * @param _previousTime the previous time.
