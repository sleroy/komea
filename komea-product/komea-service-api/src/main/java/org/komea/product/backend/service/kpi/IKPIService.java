...
public interface IKPIService {
    ...
    /**
     * Creates a KPI, stores it and instantiate it Esper. Updates the cache with
     * the query
     *
     * @param _kpi kpi
     */
     ...
     *
     * @param _entity the entity
     * @param _kpis the new list of KPI
     */
    ...
    /**
     * This method get the history measuree for a kpi on an entity
     *
     * @param _kpiKey the kpi key
     * @param _nbRow nb result asked
