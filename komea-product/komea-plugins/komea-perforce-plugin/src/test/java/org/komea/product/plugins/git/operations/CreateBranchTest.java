...
public class CreateBranchTest
{
    ...
    public void testCreationRepositoryAndScan() throws Exception {
        ...
        perforceRepositoryProxy.getScmCloner().cloneRepository();
        final Git git = perforceRepositoryProxy.getGit();
        ...
        git.push().call();
        System.out.println(perforceRepositoryProxy.getBranches());
        
        final List<IScmCommit> receivedEvents =
                perforceRepositoryProxy.getAllCommitsFromABranch("new_branch", previousTime);
