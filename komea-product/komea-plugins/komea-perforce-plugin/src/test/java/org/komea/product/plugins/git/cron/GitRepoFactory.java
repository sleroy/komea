...
public class GitRepoFactory
{
     ...
     */
    public static PerforceRepositoryProxy newGitRepositoryProxy(final ScmRepositoryDefinition _gitRepo) {
    
    
        final File storageFolder = new File("target/clone");
        final PerforceRepositoryProxy gitcloner = new PerforceRepositoryProxy(_gitRepo, storageFolder);
        return gitcloner;
