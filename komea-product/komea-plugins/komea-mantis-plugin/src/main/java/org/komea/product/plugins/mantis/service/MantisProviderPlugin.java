...
public class MantisProviderPlugin
{
    ...
    private static final Logger LOGGER                   = LoggerFactory
                                                                 .getLogger(MantisProviderPlugin.class);
     ...
     */
    public IMantisConfigurationDAO getBugZillaConfiguration() {
     ...
     */
    public void setBugZillaConfiguration(final IMantisConfigurationDAO _bugZillaConfiguration) {
    ...
    private Kpi bzKpi(
        ...
        return KpiBuilder.create().name(name).key(key).description(description).interval(0d, 1000d)
                .dailyKPI().providerType(ProviderType.BUGTRACKER).queryScript(formula).forProject()
