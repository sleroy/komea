...
public final class ScmRepositoryService implements IScmRepositoryService{
     ...
     *
     * @param _scmRepositoryName the repository name
     * @param _implementationClass the class of objects stored in the
     * repository.
     */
     ...
     *
     * @param _pluginStorageService the plugin storage service.
     */
    ...
    @Override
    public void delete(ScmRepositoryDefinition _entity) {
        remove(_entity);
    }

    @Override
    public boolean exists(String key) {
        return existScmKey(key);
    }

    @Override
    public List<ScmRepositoryDefinition> selectAll() {
        return getAllRepositories();
    }

    @Override
    public int deleteByCriteria(Object example) {
    ...
    @Override
    public int countByCriteria(Object example) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<ScmRepositoryDefinition> selectByCriteria(Object example) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<ScmRepositoryDefinition> selectByCriteriaWithRowbounds(Object example, int offset, int limit) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public ScmRepositoryDefinition selectByKey(String key) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<ScmRepositoryDefinition> selectByKeys(List<String> keys) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public ScmRepositoryDefinition selectByPrimaryKey(Serializable id) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<ScmRepositoryDefinition> selectByPrimaryKeyList(List<Serializable> _ids) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
