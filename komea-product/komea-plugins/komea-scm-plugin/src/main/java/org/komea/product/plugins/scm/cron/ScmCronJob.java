...
public class ScmCronJob implements Job
{
    ...
    private static final String KEY_SCMCLONER      = "scmcloner";
    ...
    public static String[] requiredKeys() {
        ...
        return new String[]
            { KEY_ESPER_ENGINE, KEY_REPOSITORY, KEY_SCMCLONER, KEY_PERSON_SERVICE, KEY_CRON };
    }
    ...
    public void executeGitCron(
            ...
            final IScmRepositoryService repository,
            final IGitClonerService gitcloner,
            final ScmRepositoryDefinition gitRepositoryDefinition,
    ...
    private void runCronTaskWithJobDataMap(final JobDataMap mergedJobDataMap) {
        ...
        final IScmRepositoryService repository =
                (IScmRepositoryService) mergedJobDataMap.get(KEY_REPOSITORY);
        final IGitClonerService gitcloner = (IGitClonerService) mergedJobDataMap.get(KEY_SCMCLONER);
