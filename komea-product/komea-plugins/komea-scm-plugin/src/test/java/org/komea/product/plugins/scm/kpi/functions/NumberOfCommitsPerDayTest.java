 ...
 * @author sleroy
 */
public class NumberOfCommitsPerDayTest
{
    
    
    /**
     * Test method for {@link org.komea.product.plugins.scm.kpi.functions.NumberOfCommitsPerDay#compute(java.util.Collection)}.
     */
    @Test
    public final void testCompute() throws Exception {
        ...
        newTest.sendCustomEvent(ScmKpiTestingData.fakeCommit());
        newTest.withQuery(new NumberOfCommitsPerDay());
