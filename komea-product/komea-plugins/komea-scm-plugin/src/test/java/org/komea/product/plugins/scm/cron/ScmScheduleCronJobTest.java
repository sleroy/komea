...
public class ScmScheduleCronJobTest
{
    ...
    public final void testCheckIfScmRepositoriesAreAssociatedToAJob() throws Exception {
        ...
        final IScmRepositoryService scmRepositoryService =
                Mockito.mock(IScmRepositoryService.class);
        final ScmRepositoryDefinition scmRepo = new ScmRepositoryDefinition();
        when(scmRepositoryService.getRepositoriesNotAssociated()).thenReturn(
                Lists.newArrayList(scmRepo));
        scmScheduleCronJob.checkIfScmRepositoriesAreAssociatedToAJob(scmRepositoryService,
                new JobDataMap());
    ...
    public final void testPrepareJobMapForCron() throws Exception {
        ...
        final JobDataMap prepareJobMapForCron =
                scmScheduleCronJob.prepareJobMapForCron(parentDataMap, gitRepo);
