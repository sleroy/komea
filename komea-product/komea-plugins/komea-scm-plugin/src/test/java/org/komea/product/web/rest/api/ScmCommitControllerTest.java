...
public class ScmCommitControllerTest {
    ...
    private static final Logger       LOGGER           = LoggerFactory.getLogger(ScmCommitControllerTest.class);
    ...
    public void testPushNewCommit() throws Exception {
        ...
        scmCommitDto.setProject("SCERTIFY");
        scmCommitDto.setUser("sleroy");
        ...
        final ResultActions httpRequest = mockMvc.perform(MockMvcRequestBuilders.post("/scm/new_commit/")
    ...
    public void testPushNewCommitInline() throws Exception {
        ...
        final ResultActions httpRequest = mockMvc
                .perform(MockMvcRequestBuilders.get("/scm/new_commit_inline/project/user/message/1/2/3/4"));
    ...
    public void testPushNewCommitLight() throws Exception {
        ...
        final ResultActions httpRequest = mockMvc.perform(MockMvcRequestBuilders.get("/scm/new_commit_light/SCERTIFY/sleroy/new commit")
