...
public class GitRepoFactory
{
    ...
    // final ScmRepositoryDefinition gitRepo =
    // ScmRepositoryDefinition.newGitRepository(name, gitFile.toURL().toString());
    ...
    // */
    // public static IGitClonerService newGitClonerService(final ScmRepositoryDefinition _gitRepo) {
    //
    //
