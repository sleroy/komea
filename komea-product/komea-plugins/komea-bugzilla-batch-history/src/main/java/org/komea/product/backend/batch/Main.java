...
public class Main
{
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final InputStream inputStream = FileUtils.openInputStream(new File(args[1], BATCH_CONF));
        ...
        final SqlSession openSession = build.openSession();


        LOGGER.info("Opening Spring session");
        final FileSystemXmlApplicationContext fileSystemXmlApplicationContext =
                new FileSystemXmlApplicationContext(CONFIGURATION_SPRING_APPLICATION_CONTEXT_XML);
        ...
        launchRebuilding(PROJECT_NAME, openSession, fileSystemXmlApplicationContext, springService);
