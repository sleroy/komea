...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status DELIVERED",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_DELIVERED",
        name: "Bugs with status DELIVERED",
...
query.setClosure({ "DELIVERED" == it.customFields.getField("status") })
