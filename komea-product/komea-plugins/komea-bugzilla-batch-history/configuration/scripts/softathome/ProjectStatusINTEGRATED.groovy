...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status INTEGRATED",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_INTEGRATED",
        name: "Bugs with status INTEGRATED",
...
query.setClosure({ "INTEGRATED" == it.customFields.getField("status") })
