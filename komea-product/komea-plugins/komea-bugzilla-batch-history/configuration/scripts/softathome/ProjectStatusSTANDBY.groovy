...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status STANDBY",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_STANDBY",
        name: "Bugs with status STANDBY",
...
query.setClosure({ "STANDBY" == it.customFields.getField("status") })
