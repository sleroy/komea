...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status ONHOLD",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_ONHOLD",
        name: "Bugs with status ONHOLD",
...
query.setClosure({ "ONHOLD" == it.customFields.getField("status") })
