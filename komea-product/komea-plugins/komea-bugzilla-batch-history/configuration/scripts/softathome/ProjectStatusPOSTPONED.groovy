...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status POSTPONED",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_POSTPONED",
        name: "Bugs with status POSTPONED",
...
query.setClosure({ "POSTPONED" == it.customFields.getField("status") })
