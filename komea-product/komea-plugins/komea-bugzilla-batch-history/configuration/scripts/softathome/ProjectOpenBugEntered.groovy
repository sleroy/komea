...
define "kpi", kpibuilder.kpi (
        description: "Number of opened bugs still in external customer area",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_opened_entered",
        name: "Open bugs in external custom area",
...
def enterStatus = ["UNCONFIRMED", "NEW", "ONHOLD"];
