...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status UNCONFIRMED",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_UNCONFIRMED",
        name: "Bugs with status UNCONFIRMED",
...
query.setClosure({ "UNCONFIRMED" == it.customFields.getField("status") })
