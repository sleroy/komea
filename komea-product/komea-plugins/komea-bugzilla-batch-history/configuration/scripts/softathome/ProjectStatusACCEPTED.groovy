...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status ACCEPTED",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_ACCEPTED",
        name: "Bugs with status ACCEPTED",
...
query.setClosure({ "ACCEPTED" == it.customFields.getField("status") })
