...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status REOPENED",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_REOPENED",
        name: "Bugs with status REOPENED",
...
query.setClosure({ "REOPENED" == it.customFields.getField("status") })
