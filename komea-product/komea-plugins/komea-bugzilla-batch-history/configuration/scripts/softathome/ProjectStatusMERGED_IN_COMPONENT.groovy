...
define "kpi", kpibuilder.kpi (
        description: "Number of bug with status MERGED_IN_COMPONENT",
        entityType: EntityType.PROJECT,
        groupFormula: GroupFormula.AVG_VALUE,
        kpiKey: "bugs_status_MERGED_IN_COMPONENT",
        name: "Bugs with status MERGED_IN_COMPONENT",
...
query.setClosure({ "MERGED_IN_COMPONENT" == it.customFields.getField("status") })
