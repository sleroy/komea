...
define "kpi", kpibuilder.kpi (
        ...
        kpiKey: "bugs_status_open_severity_critical",
        name: "Opened bugs with critical severity",
...
query.setClosure({ it.getStatus() == IssueStatus.OPENED && it.severity == Severity.CRITICAL})
