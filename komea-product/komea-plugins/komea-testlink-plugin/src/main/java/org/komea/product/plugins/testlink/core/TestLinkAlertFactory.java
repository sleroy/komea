...
public class TestLinkAlertFactory implements ITestLinkAlertFactory {
    ...
    public EventSimpleDto newBlockedTests(final long _alert, final String _project) {
        ...
        setEventMessage(event, "{0} tests are unexecuted tests in testlink for project {1}", _alert, _project);
    ...
    public EventSimpleDto newRequirements(final long _alert, final String _project) {
        ...
        final EventSimpleDto event = new EventSimpleDto();
        event.setProvider(TESTLINK_URL);
        setEventMessage(event, "Total number of requirements for the project {0} in testlink", _project);
    ...
    private void setEventMessage(final EventSimpleDto _event, final String _messageFormat,
            final Object... _parameters) {
        _event.setMessage(MessageFormat.format(_messageFormat, _parameters));
    }
