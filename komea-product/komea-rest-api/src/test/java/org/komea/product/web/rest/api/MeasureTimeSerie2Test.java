...
public class MeasureTimeSerie2Test extends AbstractSpringIntegrationTestCase
{
    ...
    public final void testFindMultipleHistoricalMeasureWithAllMeasuresAndKpi() throws Exception {
        ...
        final TimeSerieTableDTO timeline =
                measureController.buildTimeline("PROJECT", "komea", null);
