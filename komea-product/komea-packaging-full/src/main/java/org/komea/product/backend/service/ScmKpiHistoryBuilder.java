...
@Service
@Order(
    value = Ordered.LOWEST_PRECEDENCE)
public class ScmKpiHistoryBuilder implements IAdminAction
{
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.product.backend.service.IAdminAction#execute(org.komea.product.backend.service.ProgressListener)
     */
    @Override
    public void execute(final ProgressListener _logger) {
        ...
        try {
            ...
            _logger.progressFinish(new ProgressEvent("Repositories analysed", totalSteps,
                    totalSteps));
        }
    ...
    private void prepareRepository(
            final ScmRepositoryDefinition scmRepositoryDefinition,
