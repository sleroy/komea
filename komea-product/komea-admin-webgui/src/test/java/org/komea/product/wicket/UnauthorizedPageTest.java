...
/**
 * The class <code>UnauthorizedPageTest</code> contains tests for the class <code>{@link UnauthorizedPage}</code>.
 *
...
{
    /**
     * Run the UnauthorizedPage(PageParameters) constructor test.
     *
     * @throws Exception
     *
     * @generatedBy CodePro at 17/02/14 21:28
     */
    @Test
    public void testUnauthorizedPage_1()
        throws Exception {
        PageParameters _parameters = new PageParameters();

        UnauthorizedPage result = new UnauthorizedPage(_parameters);
        ...
        //       at org.komea.product.wicket.UnauthorizedPage.<init>(UnauthorizedPage.java:22)
    ...
    public void testGetTitle_1()
        throws Exception {
        UnauthorizedPage fixture = new UnauthorizedPage(new PageParameters());
    ...
    public static void main(String[] args) {
        new org.junit.runner.JUnitCore().run(UnauthorizedPageTest.class);
    }
}