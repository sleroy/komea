...
//        final Model<String> successModel = new Model<String>("has-success");
        ...
        final UserBdd savUserBdd=person.getUserBdd();
        add(SelectBoxBuilder.<UserBdd>createWithEnum("userBdd", person,
                UserBdd.class).build());

//         add(new FormComponentFeedbackIndicator(feedBack.getId()));
...
//                _personFormData.getPersonRoles()));
        add(DropDownBuilder.buildDropdown("selectedProject", this, "project", "name",_personFormData.getProjects()));
