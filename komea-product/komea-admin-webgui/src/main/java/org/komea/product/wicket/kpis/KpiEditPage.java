...
public class KpiEditPage extends LayoutPage {
	...
	private KpiEditPage(final PageParameters _parameters, final Kpi _kpi, final boolean isNew) {
		...
		final KpiForm kpiForm = new KpiForm(isNew, "form", kpiService, entityService, providerService, feedbackPanel,
		        new CompoundPropertyModel<Kpi>(_kpi), this, groovyEngineService);
		String message;
		if (isNew) {
