 ...
 * @author rgalerme
 */
public class CronDisableAction implements IAjaxEditAction<CronDetails> {

    private final ICronRegistryService cronService;
    private final List<CronDetails> cronTasks;
    private Component composant;

    public CronDisableAction(ICronRegistryService cronService, List<CronDetails> cronTasks) {
    ...
    public void selected(CronDetails _object, AjaxRequestTarget _target) {
        ...
        cronService.disableCronTask(_object.getCronName());
        cronTasks.clear();
