...
@MountAdminPages(
    {
            @MountPage(
                mount = "/departments",
                page = DepartmentPage.class),
                @MountPage(
                    mount = "/saveDepartment",
                    page = DepartmentEditPage.class),
                @MountPage(
                    mount = "/teams",
                    page = TeamPage.class),
                @MountPage(
                    mount = "/saveTeam",
                    page = TeamEditPage.class),
                @MountPage(
                    mount = "/kpis",
                    page = KpiPage.class),
                @MountPage(
                    mount = "/saveKpi",
                    page = KpiEditPage.class),
                @MountPage(
                    mount = "/saveProject",
                    page = ProjectEditPage.class),
                @MountPage(
                    mount = "/projects",
                    page = ProjectPage.class),
                @MountPage(
                    mount = "/settings",
                    page = SettingsPage.class),
                @MountPage(
                    mount = "/viewlog",
                    page = ConsolePage.class),
                @MountPage(
                    mount = "/stats",
                    page = StatPage.class),
                @MountPage(
                ...
                @MountPage(
                    mount = "/accessdenied",
                    page = UnauthorizedPage.class),
                @MountPage(
                    mount = "/users",
                    page = PersonPage.class),
                @MountPage(
                    mount = "/saveMember",
                    page = PersonAddPage.class),
                @MountPage(
                    mount = "/events",
                    page = EventsPage.class),
                @MountPage(
                    mount = "/plugins",
                    page = ProviderPage.class),
                @MountPage(
                    mount = "/customers",
                    page = CustomerPage.class),
                @MountPage(
                    mount = "/saveCustomer",
                    page = CustomerEditPage.class),
                @MountPage(
                    mount = "/alerts",
                    page = AlertPage.class),
                @MountPage(
                    mount = "/saveAlert",
                    page = AlertEditPage.class),
                @MountPage(
                    mount = "/kpiview",
                    page = KpiViewerPage.class),
                @MountPage(
                    mount = "/adminactions",
                    page = AdminActionPage.class) })
