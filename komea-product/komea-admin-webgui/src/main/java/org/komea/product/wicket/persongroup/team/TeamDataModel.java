...
public class TeamDataModel extends SortableDataProvider<PersonGroup, String>
{
    ...
    public TeamDataModel(final IPersonGroupService personGroupService) {
    ...
    public Iterator<? extends PersonGroup> iterator(final long _first, final long _count) {
        ...
        return (Iterator) IteratorUtil.buildIterator(personGroupService.getAllTeams(), _first,
                _count);
    }
    ...
    public long size() {
        ...
        return personGroupService.getAllTeamsPG().size();
    }
