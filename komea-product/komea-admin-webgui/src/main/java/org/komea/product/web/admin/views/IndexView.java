...
import org.komea.product.backend.service.esper.IEsperAlertSnapshotService;
import org.komea.product.backend.service.esper.IEsperQueryService;
...
public class IndexView
{
    ...
    @RequestMapping(method = {
            RequestMethod.GET, RequestMethod.POST }, value = {
        "/error.html" })
    public String customError(
        ...
        message.write(MessageFormat.format("{0} returned for {1} with message {2}", statusCode,
    ...
    public void init() {
        ...
        queryService.registerQuery("select * from Alert.win:time(60 sec)", "ACTIVITY_VIEW_PAGE");
    }
    ...
    private String getExceptionMessage(final Throwable throwable, final Integer statusCode) {
        ...
        if (throwable != null) { return getRootCause(throwable).getMessage(); }
