...
/**
 * This class defines the health formula. (number of success build / number of
 * total builds)
 * 
 * @author sleroy
 */
public class ProjectBuildHealthFormula implements IEventGroupFormula<IEvent> {
	...
	public static class HealthInformations implements Treatment<IEvent> {
		...
		public static final Set<String>	negativeActionsSet	= Sets.newHashSet("build_failed", "build_broken",
		                                                           "build_unstable", "build_interrupted");

		public static Set<String>		positiveActionsSet	= Sets.newHashSet("build_started", "build_fixed",
		                                                           "build_complete");
		 ...
		 * 
		 * @see
		 * org.komea.product.backend.utils.Treatment#apply(java.lang.Object)
		 */
		@Override
	 ...
	 * 
	 * @see
	 * org.komea.product.plugins.kpi.formula.IEventGroupFormula#evaluate(org
	 * .komea.product.cep.api.formula.tuple.IEventGroup)
	 */
	@Override
