...
public class JenkinsKPIService {
    ...
    public Kpi healthRateOfUserActions() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Project health influence").description("Project Health influence of a developer")
                .produceValue(ValueType.PERCENT, ValueDirection.BETTER).providerType(ProviderType.CI_BUILD).entityType(EntityType.PERSON)
    ...
    public Kpi jenkinsSuccessBuildRate() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Successful builds (%)").description("Success project build rate")
                .providerType(ProviderType.CI_BUILD).produceValue(ValueType.PERCENT, ValueDirection.BETTER).entityType(EntityType.PROJECT)
                .query(SuccessfulBuildRate.class).interval(0d, 100d).build();
    ...
    public Kpi numberOfBuildBrokenPerUser() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Broken builds").description("Number of broken builds")
                .produceValue(ValueType.INT, ValueDirection.WORST).providerType(ProviderType.CI_BUILD).entityType(EntityType.PERSON)
    ...
    public Kpi numberOfBuildPerDay() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Builds").description("Number of builds")
                .produceValue(ValueType.INT, ValueDirection.NONE).providerType(ProviderType.CI_BUILD).entityType(EntityType.PROJECT)
                .query(BuildPerDay.class).build();
    ...
    public Kpi numberOfConfigurationChanges() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Job conf changes").description("Number of job configuration change")
                .produceValue(ValueType.INT, ValueDirection.NONE).providerType(ProviderType.CI_BUILD).entityType(EntityType.PROJECT)
    ...
    public Kpi numberOfFailedBuildPerDay() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Failed builds").produceValue(ValueType.INT, ValueDirection.WORST)
                .description("Number of failed builds").providerType(ProviderType.CI_BUILD).entityType(EntityType.PROJECT)
                .query(NumberOfFailedBuildPerDay.class).interval(0d, 100d).build();
    }
    ...
    public Kpi numberOfFixedBuildPerUser() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Fixed builds").produceValue(ValueType.INT, ValueDirection.BETTER)
                .description("Number of fixed builds").providerType(ProviderType.CI_BUILD).entityType(EntityType.PERSON)
    ...
    public Kpi numberOfUnstableBuildPerDay() {
        ...
        return KpiBuilder.createAscending().nameAndKey("Unstable builds").produceValue(ValueType.INT, ValueDirection.WORST)
                .description("Number of unstable builds").providerType(ProviderType.CI_BUILD).entityType(EntityType.PROJECT)
                .query(NumberOfUnstableBuildPerDay.class).interval(0d, 100d).build();
    }
    
    public Kpi numberSuccessBuildPerDay() {
    
        return KpiBuilder.createAscending().nameAndKey("Successful builds").produceValue(ValueType.INT, ValueDirection.BETTER)
                .description("Number of successful builds").providerType(ProviderType.CI_BUILD).entityType(EntityType.PROJECT)
                .interval(0d, 100d).query(NumberOfSuccessfulBuildPerDay.class).build();
    }
    
    public Kpi numberOfInterruptedBuildPerDay() {
    
        return KpiBuilder.createAscending().nameAndKey("Interrupted builds").produceValue(ValueType.INT, ValueDirection.WORST)
                .description("Number of interrupted builds").providerType(ProviderType.CI_BUILD).entityType(EntityType.PROJECT)
                .interval(0d, 100d).query(NumberOfInterruptedBuildPerDay.class).build();
    }
