 ...
 * @author sleroy
 */
public class NumberOfJobConfigurationChangesPerDay implements ICEPQueryImplementation
{
     ...
     * 
     */
    public NumberOfJobConfigurationChangesPerDay() {
    ...
    public List<IFilterDefinition> getFilterDefinitions() {
        ...
        final IEventFilter<?> eventFilter =
                EventFilterBuilder.create().chain(new OnlyEventFilter())
                        ...
                        .chain(new EventTypeFilter("job_configuration_changed")).build();
