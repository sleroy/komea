 ...
 * @author sleroy
 */
public class NumberOfFailedBuildPerDay implements ICEPQueryImplementation
{
    ...
    public List<IFilterDefinition> getFilterDefinitions() {
        ...
        final IEventFilter<?> eventFilter =
                EventFilterBuilder
                        ...
                        .chain(new EventTypeFilter("build_failed", "build_broken", "build_failed",
                                "build_interrupted")).build();
