...
public class SonarEventFactory
{
    ...
    public EventSimpleDto sendAuditStarted(final String _projectName, final double _value) {
    ...
    public EventSimpleDto sendAuditSuccess(final String _projectName, final double _value) {
    ...
    public EventSimpleDto sendMetricValue(
            final String _projectName,
            final double _value,
            final java.lang.String _metricName) {
