...
public class CEPQueryTester {
    ...
    private static class ArrayPredicate implements ICEPQueryTestPredicate {
         ...
         * @see
         * org.komea.product.backend.service.kpi.ICEPQueryTestPredicate#evaluate(EPStatement)
         */
        @Override
    ...
    private static class SingleLinePredicate implements ICEPQueryLineTestPredicate {
         ...
         * Method evaluate.
         *
         * @param _tuple Map<String,Object>
         * @see
     ...
     *
     * @param _testPredicate ICEPQueryLineTestPredicate
     * @return CEPQueryTester
     */
     ...
     * single value.
     *
     * @param _singleResult the single result.
     * @return
     */
     ...
     *
     * @param esperEngineBean ICEPEngine
     */
    ...
    public void validPredicates() {
        ...
        if (esperPredicates.isEmpty() && !hasMapPredicates() && singleResult == null) {
            return;
        }
        validateQueryPredicates();

        if (!cepQuery.getResult().isMap() && hasMapPredicates()) {
