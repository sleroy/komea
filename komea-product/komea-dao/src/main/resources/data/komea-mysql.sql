...
-- -----------------------------------------------------
-- Table `kom_has_proj_pegr`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `kom_has_proj_pegr` (
  `idProject` INT NOT NULL ,
...
-- Table `kom_acfi`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `kom_acfi` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `entityType` VARCHAR(255) NOT NULL ,
  `idEntity` INT NULL ,
...
-- Table `kom_sfac`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `kom_sfac` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `successFactorKey` VARCHAR(255) NOT NULL ,
  `name` VARCHAR(255) NOT NULL ,
  `description` VARCHAR(2048) NULL ,
  PRIMARY KEY (`id`),
  UNIQUE(`successFactorKey`)
 )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kom_has_sfac_kpi`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `kom_has_sfac_kpi` (
...
-- Table `kom_kpigoal`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `kom_kpigoal` (
  `id` INT NOT NULL ,
  `idKpi` INT NOT NULL ,
  `entityID` INT NULL ,
