...
public class Kpi implements Serializable {
     ...
     * @mbggenerated Thu Jan 09 12:21:15 CET 2014
     */
    public Kpi(Integer idKpi, String key, String name, Integer idProvider, Double minValue, Double maxValue, Integer valueDirection, Integer valueType, Integer entityType) {
        this.idKpi = idKpi;
        this.key = key;
        this.name = name;
