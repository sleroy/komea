...
public class Kpi implements Serializable {
     ...
     * @mbggenerated Fri Jan 10 15:10:49 CET 2014
     */
    public Kpi(Integer id, String key, String name, String description, Integer idProvider, Double minValue, Double maxValue, Integer valueDirection, Integer valueType, Integer entityType, String esperRequest) {
        this.id = id;
        this.key = key;
        this.name = name;
