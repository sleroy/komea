...
public class KpiAlertType implements Serializable {
     ...
     * @mbggenerated Fri Jan 10 15:10:49 CET 2014
     */
    public KpiAlertType(Integer id, Integer idKpi, String key, String name, String description, Integer severity, Double value, Date averageSince, Integer operator, Boolean enabled) {
        this.id = id;
        this.idKpi = idKpi;
        this.key = key;
        this.name = name;
