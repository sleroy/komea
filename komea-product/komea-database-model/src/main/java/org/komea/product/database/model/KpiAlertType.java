...
public class KpiAlertType implements Serializable {
     ...
     * @mbggenerated Thu Jan 09 19:15:19 CET 2014
     */
    public KpiAlertType(Integer id, Integer idKpi, String key, String name, Integer severity, Double value, Date averageSince, Integer operator, Boolean enabled, String description) {
        this.id = id;
        this.idKpi = idKpi;
        this.key = key;
        this.name = name;
