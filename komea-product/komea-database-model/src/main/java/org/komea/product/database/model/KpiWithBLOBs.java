...
public class KpiWithBLOBs extends Kpi implements Serializable {
     ...
     * @mbggenerated Thu Jan 09 19:15:19 CET 2014
     */
    public KpiWithBLOBs(Integer id, String key, String name, Integer idProvider, Double minValue, Double maxValue, Integer valueDirection, Integer valueType, Integer entityType, String description, String esperRequest) {
        super(id, key, name, idProvider, minValue, maxValue, valueDirection, valueType, entityType);
