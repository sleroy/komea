...
public class KpiWithBLOBs extends Kpi implements Serializable {
     ...
     * @mbggenerated Thu Jan 09 10:55:40 CET 2014
     */
    public KpiWithBLOBs(Integer idKpi, String key, String name, Integer idProvider, Double minValue, Double maxValue, Integer biggerBetter, Integer valueType, Integer entityType, String description, String esperRequest) {
        super(idKpi, key, name, idProvider, minValue, maxValue, biggerBetter, valueType, entityType);
