...
public class EvaluateKpiValuePerformanceTest extends AbstractSpringIntegrationTestCase
{
    ...
    private static final Logger  LOGGER                 =
                                                                LoggerFactory
                                                                        .getLogger(EvaluateKpiValuePerformanceTest.class);
    ...
    public void groupElementsPerDay() {
        ...
        basicMicroBenchmark.run(new Runnable()
        {
            ...
            public void run() {
                ...
                statisticsAPI.evaluateKpiValue(timeSerieOptions,
