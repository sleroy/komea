...
public class BuildPeriodTimeSeriesPerformanceTest extends AbstractPerformanceTest {
	...
	public void groupElementsPerDay() {
		...
		basicMicroBenchmark.run(new Runnable() {
			...
			public void run() {
				...
				statisticsAPI.buildPeriodTimeSeries(timeSerieOptions, EntityKey.of(EntityType.PROJECT, 1));
