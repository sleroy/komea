...
public class BuildTimeSeriesEntityPerformanceTest extends AbstractSpringIntegrationTestCase
{
    ...
    private static final Logger  LOGGER                 =
                                                                LoggerFactory
                                                                        .getLogger(BuildTimeSeriesEntityPerformanceTest.class);
    ...
    private void sameTimeSerieConfig(final TimeSerieOptions timeSerieOptions) {
