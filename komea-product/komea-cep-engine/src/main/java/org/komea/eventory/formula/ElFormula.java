...
import org.komea.eventory.api.formula.IElFormula;
...
public class ElFormula<T> implements IElFormula<T>
{
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.formula.IElFormula#getFormula()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.formula.IElFormula#getValue(java.lang.Object)
     */
    @Override
