...
//        Mockito.mock(null)
        ...
        TestLinkServer testLinkServer = new TestLinkServer("http://ares.tocea/testlink/lib/api/xmlrpc.php", "2dec70df08045278463817fb15d79c4d");
        configurations.add(testLinkServer);
//        configurations.add(new TestLinkServer("http://127.0.0.1:8080/testlink/lib/api/xmlrpc/v1/xmlrpc.php", "cf86c231b7c909f15b4d61e12ace5507"));
