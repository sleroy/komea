...
//        bbean.setAlertFactory(Mockito.mock(IBugZillaAlertFactory.class));
        ...
        IBugZillaServerProxyFactory bzfact = Mockito.mock(IBugZillaServerProxyFactory.class);
        IBugZillaServerProxy j2connector = Mockito.mock(IBugZillaServerProxy.class);

        List<String> listProjet = new ArrayList<String>();
        listProjet.add("Makeb");
        listProjet.add("Cornelia");

        Mockito.when(j2connector.getListProjects()).thenReturn(listProjet);

        List<BugzillaBug> listMakeb = new ArrayList<BugzillaBug>();
        Date d = new Date();
        Date d1 = new Date();
        Date d2 = new Date();
        ...
        List<BugzillaBug> listCornelia = new ArrayList<BugzillaBug>();
