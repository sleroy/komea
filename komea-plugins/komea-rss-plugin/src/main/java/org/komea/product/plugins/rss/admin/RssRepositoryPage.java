...
public class RssRepositoryPage extends LayoutPage
{
    ...
    public RssRepositoryPage(final PageParameters _parameters) {
    ...
    public RssRepositoryPage(final PageParameters _parameters, final PersonDto _personDTO) {
    
    
        super(_parameters);
        
        
        final IDeleteAction<Person> personDeleteAction = new RssRepositoryDeleteAction(personDAO);
        
        final IEditAction<Person> personEditAction = new RssRepositoryEditAction(this, personRoleDAO);
    ...
    public String getTitle() {
        ...
        return getString("RssRepositoryPage.title");
    }
