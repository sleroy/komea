...
public class IEventStorageTest {
	...
	// this.eventStorage = new EventStorage(mock(IOrientSessionFactory.class),
	// this.documentToolBox);
	// }
	//
	// /**
	...
	//
	// // THEN
	// Mockito.verify(this.documentToolBox,
	// Mockito.times(1)).newDocument(NEW_BUG);
	// Mockito.verify(odocument,
	// Mockito.times(1)).field(IBasicEventInformations.FIELD_PROVIDER,
	// BUGZILLA);
	// Mockito.verify(odocument,
	// Mockito.times(1)).field(IBasicEventInformations.FIELD_EVENT_TYPE,
	// NEW_BUG);
	// Mockito.verify(odocument,
	// Mockito.times(1)).field(IBasicEventInformations.FIELD_DATE, newDate);
	...
	// }
	//
	// private void configureMock(final IODocument odocument, final Date
	// newDate) {
