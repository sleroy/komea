...
public class KomeaEvent implements IKomeaEvent, Serializable {
    ...
    public KomeaEvent() {
        properties.put(IKomeaEvent.FIELD_DATE, new Date());
    }

    public KomeaEvent(final String _provider, final String _eventType) {
        this();
        properties.put(IKomeaEvent.FIELD_PROVIDER, _provider);
        properties.put(IKomeaEvent.FIELD_EVENT_TYPE, _eventType);
    }
