...
public class JacksonMySQLAdvancedEventDB implements IEventDB {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(JacksonMySQLAdvancedEventDB.class);
    private DBI db;
    ...
    public void createSQL(final String _table) {
        insertStatementSQL = "INSERT INTO `" + _table + "` (date, data) VALUES (:date, :data);";
    ...
    private void createTable(final String _eventType) {
        ...
        try {
            ...
            try (InputStream resourceAsStream = Thread.currentThread()
                    ...
                    .getResourceAsStream("tables/table_mysql.sql")) {
