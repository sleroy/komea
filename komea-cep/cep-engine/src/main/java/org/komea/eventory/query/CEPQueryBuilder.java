...
public class CEPQueryBuilder {
	...
	public CEPQueryBuilder defineFilter(final IEventFilter _noEventFilter) {
		...
		cepQueryDefinition.addFilterDefinition(FilterDefinition.create().setFilterName(_noEventFilter.toString())
		        .setCacheConfiguration(CacheConfigurationBuilder.noConfiguration()).setFilter(_noEventFilter));
		return this;
	}
	...
	public CEPQueryBuilder defineFilter(final IEventFilter _filter, final ICacheConfiguration _cacheConfiguration) {

		cepQueryDefinition.addFilterDefinition(FilterDefinition.create().setFilterName("stream" + numberOfFilters())
	...
	public CEPQueryBuilder defineFilter(final String _filter, final IEventFilter<?> _eventFilter,
	 ...
	 */
	@SuppressWarnings("unchecked")
	public CEPQueryBuilder defineFilterAndTransformer(final IEventFilter _filter, final IEventTransformer _transformer,
	        final ICacheConfiguration _cacheConfiguration) {

		cepQueryDefinition.addFilterDefinition(FilterDefinition.create().setFilterName("stream" + numberOfFilters())
		        .setCacheConfiguration(_cacheConfiguration).setFilter(_filter).setEventTransformer(_transformer));
