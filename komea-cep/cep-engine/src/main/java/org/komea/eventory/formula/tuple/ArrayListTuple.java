...
public class ArrayListTuple implements ITuple
{
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.ITuple#append(java.util.Map.Entry)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.formula.tuple.ITuple#asMap()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.ITuple#getByIndex(int)
     */
    @Override
    public <T> T getFirst() {
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.ITuple#isSingleton(java.lang.Object)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.ITuple#isSingleton()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.ITuple#size()
     */
    @Override
    public int size() {
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.ITuple#values()
     */
    @Override
