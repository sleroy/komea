...
public class EventGroup implements IEventGroup
{
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.IEventGroup#addEvent(java.io.Serializable)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.IEventGroup#getEvents()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.komea.eventory.api.formula.tuple.IEventGroup#getFirstEvent()
     */
    @Override
